...
const GridItem = ({
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-body text-xs uppercase tracking-[0.2em] text-glacier-primary">
          {item.subtitle}
        </span>
        <h3 className="font-display text-headline text-glacier-deep mt-3">
          {item.title}
        </h3>
        <p className="font-body text-sm md:text-base text-glacier-dark/70 leading-relaxed mt-6">
          {item.description}
        </p>

        {/* Decorative line */}
        <div className="w-16 h-px bg-glacier-primary/30 mt-8" />
      </div>
    </div>
  );
};
...
const ZigZagGrid = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full py-24 md:py-32 lg:py-40 bg-ice-snow"
    >
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
        ...
        <div ref={headerRef} className="text-center mb-20 md:mb-28">
          ...
          <h2 className="font-display text-headline text-glacier-deep mt-4">
