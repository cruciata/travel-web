...
const BreathSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full py-16 md:py-24 bg-ice-snow"
    >
      <div className="px-4 md:px-8">
        ...
        >
          ...
          <div className="relative aspect-[16/9] md:aspect-[21/9]">
            ...
            <div className="absolute inset-0 bg-glacier-deep/40" />

            {/* Content */}
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <h2
                ref={textRef}
                className="font-display text-display text-ice-white tracking-tight"
                style={{
                  willChange: 'transform, opacity',
                  textShadow: '0 4px 30px rgba(10, 37, 64, 0.4)'
                }}
              >
              ...
              <p
                ref={subtitleRef}
                className="font-body text-ice-white/80 text-sm md:text-base uppercase tracking-[0.3em] mt-6"
            ...
            <div className="absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-glacier-deep/20 to-transparent" />
            <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-glacier-deep/20 to-transparent" />
          </div>
        </div>
      </div>
      ...
      {breathSectionConfig.description && (
        <div className="max-w-4xl mx-auto px-6 md:px-8 mt-16 md:mt-24 text-center">
          <p className="font-body text-sm text-glacier-dark/60 max-w-lg mx-auto leading-relaxed">
            {breathSectionConfig.description}
          </p>
        </div>
      )}
