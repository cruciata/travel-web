...
const NarrativeText = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full py-32 md:py-48 lg:py-56 bg-ice-snow"
    >
      <div className="max-w-4xl mx-auto px-6 md:px-8 text-center">
        ...
        >
          <StarIcon className="w-6 h-6 md:w-8 md:h-8 text-glacier-primary spin-slow" />
        </div>
        ...
        <div className="space-y-8 md:space-y-10">
          <p
            ref={line1Ref}
            className="font-display text-headline text-glacier-deep"
            style={{ willChange: 'transform, opacity' }}
          >
          ...
          <p
            ref={line2Ref}
            className="font-display text-subheadline text-glacier-dark/80 italic max-w-2xl mx-auto"
            style={{ willChange: 'transform, opacity' }}
          >
          ...
          <p
            ref={line3Ref}
            className="font-body text-sm md:text-base text-glacier-dark/60 max-w-lg mx-auto leading-relaxed tracking-wide"
            style={{ willChange: 'transform, opacity' }}
          >
        ...
        <div className="flex justify-center mt-16">
          <StarIcon className="w-4 h-4 text-glacier-primary/50" />
        </div>
      </div>
    </section>
  );
