...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={overlayRef}
        className="absolute inset-0 bg-glacier-deep opacity-0"
        style={{ willChange: 'opacity' }}
      />

      {/* Subtle fog effect overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-ice-snow/20" />
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
        ...
        <h1
          ref={titleRef}
          className="font-display text-ice-white text-display tracking-tight select-none"
          style={{
        ...
        <p
          ref={subtitleRef}
          className="font-body text-ice-white/90 text-sm md:text-base uppercase tracking-[0.3em] mt-6"
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-ice-snow to-transparent" />
    </section>
  );
};
